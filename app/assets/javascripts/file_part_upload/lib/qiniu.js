...
function QiniuJsSDK() {
    ...
    /**
     * 以下代码是为了适用于局域网文件上传需求，开发了兼容七牛 js sdk 的 server 端
    */
    if(window.use_lan_qiniu_compatibility_mode){
      qiniuUploadUrl  = window.lan_qiniu_compatibility_mode_upload_url;
      qiniuUploadUrls = [ qiniuUploadUrl, qiniuUploadUrl ];
    }
